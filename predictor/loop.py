...
def run(date=None):
    ...
    steps = [
        ...
        ("Loop C · props +EV · log flags WC (Linemate)", lambda: prop_value.log_props(date, "wc")),
        ("Loop C · props +EV · log flags MLB (Linemate)", lambda: prop_value.log_props(date, "mlb")),
        ("Loop C · props +EV · resolver (statsapi MLB)", lambda: prop_value.resolve_props(date)),
